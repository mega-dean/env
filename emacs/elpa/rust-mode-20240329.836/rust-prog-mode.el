...
(defvar rust-font-lock-keywords
  (append
   `(
     ...
     ;; Bools
     (,(regexp-opt rust-bools 'symbols) . font-lock-constant-face)
     ...
     (,rust-re-type-or-constructor 1 font-lock-builtin-face)
     ...
     (,(rust-path-font-lock-matcher rust-re-lc-ident) 1 font-lock-variable-name-face)
   ...
   (mapcar #'(lambda (x)
           ...
           '(("enum" . font-lock-type-face)
             ...
             ("mod" . font-lock-variable-name-face)
